...
pubDate: 'Mar 05 2024'
heroImage: '../../assets/images/element-plus.png'
category: '技術'
...
- 套件名稱 & 功能需研究
    ...
    - vite.config.ts 設置
        - path 以及 __dirname 所各自代表的意思
        - resolve 設定
        - css 的 preprocessorOptions 功能
    - unplugin-vue-components/vite 的功能 ( 套件名: unplugin-vue-components)
    - unplugin-vue-components/resolvers 的 ElementPlusResolver 的功能  ( 套件名: unplugin-vue-components 同上)
    - unplugin-element-plus/vite 的功能 ( 套件名: unplugin-element-plus )
    - unplugin-auto-import/vite 的功能  ( 套件名: unplugin-auto-import )
    - 以及使用 component ( unplugin-vue-components/vite ) 以及 ElementPlus (unplugin-element-plus/vite) 的區別
- scss 的使用區別
    
    import 以及 @use xxxx as * 的差別
